...
class DetailMateriPwb extends StatefulWidget {
  Materi materi;
  final Category category;

  DetailMateriPwb(this.category);

  @override
  _DetailMateriPwbState createState() => _DetailMateriPwbState();
}

class _DetailMateriPwbState extends State<DetailMateriPwb> {
...
class BestSellerClipper2 extends CustomClipper<Path> {
  @override
  getClip(Size size) {
    var path = Path();
